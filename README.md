<div align="center">
  <br />
      <img src="https://github.com/Kash1shTyagi/FinFlow/assets/151519281/3c03519c-7ebd-4539-b598-49e63d1770b4" alt="Project Banner">
    </a>
  <br />
  ...
  <h3 align="center">Finflow: A Fintech Bank Application</h3>

   <div align="center">
     FinFlow is a financial SaaS platform developed with Next.js, offering users seamless connectivity to multiple bank accounts, real-time transaction monitoring, fund transfers, and comprehensive financial management capabilities.
    </div>
</div>
...
```bash
git clone https://github.com/Kash1shTyagi/FinFlow.git
cd FinFlow
```
